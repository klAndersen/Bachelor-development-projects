...
namespace Server {
    ...
    public class Kontroll : MarshalByRefObject {
        ...
        public int countEiendom() {
            int antall = eiendomsliste.Count;            
            return antall;
        } //countEiendom
        ...
        public void lagreAlt() {
            bambooEngine.TakeSnapshot(); //lager nytt snapshot
        } //lagreAlt
