 ...
 * hovedsaklig på å skrive boolske variabler til fil.  <br />
 * Disse variablene er tilknyttet hvilke hendelser som bruker ønsker å logge.
...
public class Filbehandling {
	...
	/**
	 * Oppretter en ArrayList<String> basert på filinnhold. <br />
	...
	public static void skrivTilFil(Context context, ArrayList<Boolean> loggListe) {
		try {
			...
			//(vil ligge på indeks:0 dersom nåværende registrering er første registrering) 
