...
namespace Oblig6_Oppg2_KnutLucasAndersen {
    ...
    /// </summary>
    public class Oppgave2 : Microsoft.Xna.Framework.Game {
        ...
        protected override void Initialize() {
            ...
            Window.Title = "Oblig6 Oppg2 - Knut Lucas Andersen";
        ...
        protected override void Draw(GameTime gameTime) {
            ...
            bool brukBasicEffect = false;

            if (brukBasicEffect) {
                //sett til true/false basert på VertexColorEnabled
                bool visFarge = true;
                //sett til true/false basert på om Phong-shading skal brukes
                bool brukPhong = true;
                //setter fargen 
                Color diffusFarge = Color.Black;
                tegnTerrengMedBasicEffect(worldMatrix, visFarge, diffusFarge, brukPhong);
            } else {
        ...
        /// <param name="brukPhong">Bool - Phong-shading brukes/ikke brukes</param>
        private void tegnTerrengMedBasicEffect(Matrix worldMatrix, bool visFarger, Color diffusFarge, bool brukPhong) {
            //slå av/på farger og lys
            bEffect.VertexColorEnabled = visFarger;
            bEffect.EnableDefaultLighting();
            bEffect.LightingEnabled = true;
            //slår av/på Phong - shading 
            bEffect.PreferPerPixelLighting = brukPhong;
