...
namespace Oblig1B_KnutLucasAndersen {
    ...
    public class Oblig1B : Microsoft.Xna.Framework.Game {
        ...
        private void InitVertices() {
            ...
            verteksSider[1].Position = new Vector3(-0.5f, 0.5f, 0.5f); //øverst til venstre - front
            verteksSider[2].Position = new Vector3(0.5f, -0.5f, 0.5f); //nederst til høyre - front
            verteksSider[3].Position = new Vector3(0.5f, 0.5f, 0.5f); //øverst til høyre - front

            verteksSider[4].Position = new Vector3(0.5f, -0.5f, -0.5f); //nederst til høyre - bak
            verteksSider[5].Position = new Vector3(0.5f, 0.5f, -0.5f); //øverst til høyre - bak
            verteksSider[6].Position = new Vector3(-0.5f, -0.5f, -0.5f); //nederst til venstre - bak

            verteksSider[7].Position = new Vector3(-0.5f, 0.5f, -0.5f); //øverst til venstre - bak
            verteksSider[8].Position = verteksSider[0].Position; //nederst til venstre - front
            verteksSider[9].Position = verteksSider[1].Position; //øverst til venstre - front
            //tegning av toppen til kuben
            verteksTopp[0].Position = verteksSider[1].Position; //øverst til venstre - front
            verteksTopp[1].Position = verteksSider[7].Position; //øverst til venstre - bak
            verteksTopp[2].Position = verteksSider[3].Position; //øverst til høyre - front
            verteksTopp[3].Position = verteksSider[5].Position; //øverst til høyre - bak
            ...
            verteksBunn[2].Position = verteksSider[2].Position; //nederst til høyre - front
            verteksBunn[3].Position = verteksSider[5].Position; //nederst til høyre - bak
            ...
            //Merk: Deler av trekanten blir grønn, dette pga fargen settes på topp og bunn
            //samme kordinater
        }
